#old method--String formatting can be done in python using the format method.
txt = "For only {price:.2f} dollars!"
print(txt.format(price = 49))


""" new method--f-strings in python
...
val = 'Geeks'  
print(f"{val}for{val} is a portal for {val}.")                               #output : Geeks for Geeks is a portal for Geeks
