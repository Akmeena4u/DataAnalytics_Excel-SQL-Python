...
#Note: We can provide a default value while creating a function. This way the function assumes a default value even if a value is not provided in the function call for that argument.

#1-Default Argument :
def name(fname, mname = "Jhon", lname = "Whatson"):
    print("Hello,", fname, mname, lname)

name("Amy")   #function calling
#Output: Hello, Amy Jhon Whatson



#2-Keyword arguments: We can provide arguments with key = value, this way the interpreter recognizes the arguments by the parameter name. Hence, the order in which the arguments are passed does not matter.
...
name("Peter", "Quill")\
#output:-TypeError: name() missing 1 required positional argument: 'lname'
