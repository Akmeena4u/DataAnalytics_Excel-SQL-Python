...
str2 = "Silver Spoon"
print(str2.split(" "))                      #Output: ['Silver', 'Spoon']        Splits the string at the whitespace " ". 
...
print(capStr1)                              #output : Hello world
...
str1 = "Welcome to the Console !!!"
print(str1.endswith("to", 4, 10))          #Output: True
...
str1 = "He's name is Dan. Dan is an honest man."
print(str1.index("Daniel"))               #Output: ValueError: substring not found
...
#20-startswith() : The startswith() method checks if the string starts with a given value. If yes then return True, else return False.
...
#22-title() : The title() method capitalizes each letter of the word within the string.helpful while writting blog posts
str1 = "He's name is Dan. Dan is an honest man."
